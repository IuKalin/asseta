# Đặc Tả Kỹ Thuật: Thẻ Hành Động Khẩn Cấp (Action Cards)

**Trạng thái:** v0.1.0 DRAFT  
**Tiêu chuẩn áp dụng:** EARS Framework & Clean Architecture

## 1. Mô Tả Chung
Module `feat-02-action-cards` chịu trách nhiệm cung cấp chức năng `Thẻ Hành Động Khẩn Cấp (Action Cards)` trong hệ sinh thái Asseta.
