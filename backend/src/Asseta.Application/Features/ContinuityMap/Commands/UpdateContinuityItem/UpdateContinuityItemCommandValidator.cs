...
public class UpdateContinuityItemCommandValidator : AbstractValidator<UpdateContinuityItemCommand>
{
    public UpdateContinuityItemCommandValidator()
    {
        RuleFor(x => x.Id)
        ...
        RuleFor(x => x.RowVersion)
            .GreaterThanOrEqualTo(1).WithMessage("Valid RowVersion is required for concurrency control.");
    }
}
